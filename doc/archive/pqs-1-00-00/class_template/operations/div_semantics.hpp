...
#ifndef PHYSICAL_QUANTITY_CLASS_TEMPLATE_DIV_SEMANTICS_HPP_INCLUDED2911030401
#define PHYSICAL_QUANTITY_CLASS_TEMPLATE_DIV_SEMANTICS_HPP_INCLUDED2911030401
...
namespace physical_quantities{
    ...
    // pq_mul_result_t is a metawidget returning
    // working data for divide
    // of two pqs
    template
    <
    ...
    struct pq_div_semantics{
        ...
        // calc type to minimum of float
        typedef typename math_promote
        <
            value_type,float 
        > ::type  calc_type;
        
        // return type for division 
        typedef p_quantity
        <
