...
// this version uses noexplicit unit conversion ctors
// wont work with the PHYSICAL_QUANTITIES_USE_EXPLICIT_CONVERSION_CTOR switch
...
public:
	...
	q_force::kgf weight()
	{
		...
		return mass * q_acceleration::SI::g;  
	}
private:
    struct PQ_contents{
        PQ_contents()
...
int main()
{
    PQ_box pq_box(q_length::mm(1000) ,q_length::mm(500),q_length::mm(200));
