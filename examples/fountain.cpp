...
namespace {
   ...
   auto constexpr g = 9.8_q_m_per_s2;
   auto constexpr water_density = 1000.0_q_kg_per_m3;
}
...
int main()
{
   ...
   */
   auto constexpr spray_height = 0.6_q_m;
   auto constexpr nozzle_radius = 0.5_q_mm;
