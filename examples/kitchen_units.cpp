...
int main()
{
   ...
   let base_unit_floor_height = 870_q_mm; // top of base unit above floor

   std::cout << "height floor to top of base unit = " << base_unit_floor_height << '\n';

   let worktop_thickness = 38_q_mm; // thickness of laminated worktop
   ...
   let hob_panbase_height = 35_q_mm;  // height of hob pan base above worktop
   let hob_wallunit_clearance_height = 462_q_mm; // from hob to lowest part of wall unit inc wallunit plinth
   let wallunit_plinth_height = 35_q_mm; // plinth under wall unit
   ...
   let wallunit_height = 720_q_mm;  // top to bottom of wall unit without plinth or cornice
   ...
   let wallunit_fixing_height = 56_q_mm; // height below top of wall unit for fixings
   ...
   let cornice_height = 35_q_mm; // cornice on top of wall unit
