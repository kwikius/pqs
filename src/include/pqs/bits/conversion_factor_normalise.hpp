...
namespace  pqs { 
   ...
   struct conversion_factor_normalise{
      ...
      typedef typename pqs::meta::eval_if<
         std::ratio_greater_equal<typename pqs::detail::std_ratio_abs<typename RatioExp::ratio>::type,std::ratio<10,1> >
            ,pqs::detail::conversion_factor_make_ratio_less_than_10<
                RatioExp
            >
         ,std::ratio_less<typename pqs::detail::std_ratio_abs<typename RatioExp::ratio>::type,std::ratio<1,1> >
