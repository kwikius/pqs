#ifndef QUAN_DETAIL_RATIO_EXP_MAKE_RATIO_LESS_EQUAL_1_HPP_INCLUDED
#define QUAN_DETAIL_RATIO_EXP_MAKE_RATIO_LESS_EQUAL_1_HPP_INCLUDED
...
namespace pqs{ 
   ...
   namespace detail{
      ...
      struct ratio_exp_abs_make_ratio_less_equal_1{
         static_assert(std::ratio_greater<typename RatioExp::ratio,std::ratio<0,1> >::value);
         typedef typename pqs::meta::eval_if<
            std::ratio_less_equal<typename RatioExp::ratio,std::ratio<1> >
            ,RatioExp
            ,ratio_exp_abs_make_ratio_less_equal_1<
               ratio_exp<
      ...
      template <typename RatioExp>
      struct ratio_exp_non_zero_make_ratio_less_equal_1{
         ...
         typedef typename ratio_exp_abs_make_ratio_less_equal_1<abs_type_in>::type abs_type_out;
      ...
      template <typename RatioExp>
      struct ratio_exp_make_ratio_less_equal_1{
          // remove zero case
          typedef typename pqs::meta::eval_if<
            std::ratio_equal<typename RatioExp::ratio,std::ratio<0,1> >
            ,ratio_exp< std::ratio<0,1>,0>
            ,ratio_exp_non_zero_make_ratio_less_equal_1<RatioExp>
          >::type type;      
      };
...
#endif // QUAN_DETAIL_RATIO_EXP_MAKE_RATIO_LESS_EQUAL_1_HPP_INCLUDED
