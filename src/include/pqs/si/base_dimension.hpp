#ifndef PQS_SI_BASE_DIMENSION_HPP_INCLUDED
#define PQS_SI_BASE_DIMENSION_HPP_INCLUDED
...
namespace pqs{
   namespace si{
      ...
      namespace detail {
         ...
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_length<Ratio::num>,pqs::si::dim_length_ratio<Ratio::num,Ratio::den>
         >{};

         template <typename Ratio> 
         struct make_base_dimension_ratio_impl<base_dimension_id_t::time, Ratio> 
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_time<Ratio::num>,pqs::si::dim_time_ratio<Ratio::num,Ratio::den>
         >{};

         template <typename Ratio> 
         struct make_base_dimension_ratio_impl<base_dimension_id_t::mass, Ratio> 
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_mass<Ratio::num>,pqs::si::dim_mass_ratio<Ratio::num,Ratio::den>
         >{};

         template <typename Ratio> 
         struct make_base_dimension_ratio_impl<base_dimension_id_t::temperature, Ratio> 
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_temperature<Ratio::num>,pqs::si::dim_temperature_ratio<Ratio::num,Ratio::den>
         >{};

         template <typename Ratio> 
         struct make_base_dimension_ratio_impl<base_dimension_id_t::current, Ratio> 
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_current<Ratio::num>,pqs::si::dim_current_ratio<Ratio::num,Ratio::den>
         >{};

         template <typename Ratio> 
         struct make_base_dimension_ratio_impl<base_dimension_id_t::substance, Ratio> 
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_substance<Ratio::num>,pqs::si::dim_substance_ratio<Ratio::num,Ratio::den>
         >{};

         template <typename Ratio> 
         struct make_base_dimension_ratio_impl<base_dimension_id_t::intensity, Ratio> 
         : std::conditional< 
            Ratio::den == 1, pqs::si::dim_intensity<Ratio::num>,pqs::si::dim_intensity_ratio<Ratio::num,Ratio::den>
         >{};
...
#endif // PQS_SI_BASE_DIMENSION_HPP_INCLUDED
