...
*/
   template <
      ...
      typename RhsD, 
      typename ResultD,
      pqs::si::detail::base_dimension_id_t Id,
   ...
   >struct bin_op_base_dim_to_dimension_result{
      ...
      bin_op_base_dim_to_dimension_result<
         ...
         ResultD,
         Id,
         pqs::si::detail::add_base_dimension_ratio
      >{};
      ...
      bin_op_base_dim_to_dimension_result<
         ...
         ResultD,
         Id,
         pqs::si::detail::subtract_base_dimension_ratio
      >{};
...
namespace{
   ...
   void add_base_dim_test()
   {
      ...
      > lhs_dimension;
       ...
       typedef pqs::dimension< pqs::si::dim_mass<2>, pqs::si::dim_time<1> > rhs_dimension;

       typedef pqs::dimension<> result_dimension;
       typedef pqs::si::detail::bin_op_base_dim_to_dimension_result<
         lhs_dimension,rhs_dimension,result_dimension, 
            pqs::si::detail::base_dimension_id_t::mass,
            pqs::si::detail::add_base_dimension_ratio
       >::type result_dimension1;

       QUAN_CHECK((std::is_same<result_dimension1, pqs::dimension<pqs::si::dim_mass<4> > >::value))


       typedef pqs::si::detail::add_base_dim_to_dimension_result<
         lhs_dimension,rhs_dimension,result_dimension1, 
            pqs::si::detail::base_dimension_id_t::time
