      ...
      struct ratio_exp_add{
         ...
         typedef typename pqs::meta::eval_if<
            ...
            std::bool_constant<(comp_type::value < 0)>,  // lhs is smaller, so adjust rhs
               ratio_exp_add_exp_n<rhs_type, lhs_type::exp - rhs_type::exp>,
            ratio_exp_add_exp_n<lhs_type, rhs_type::exp - lhs_type::exp>
         >::type aligned_type;
        ...
        typedef typename ratio_exp_normalise<result_type>::type type;
...
namespace {
   ...
   void compare_test3()
   {
      ...
      QUAN_CHECK((pqs::detail::ratio_exp_less<v1,v2>::value == true)) //f
      QUAN_CHECK((!pqs::detail::ratio_exp_less<v2,v1>::value))

      QUAN_CHECK((pqs::detail::ratio_exp_less_equal<v1,v2>::value)) // f
      QUAN_CHECK((!pqs::detail::ratio_exp_less_equal<v2,v1>::value))

      QUAN_CHECK((pqs::detail::ratio_exp_equal<v1,v1>::value))
      QUAN_CHECK((!pqs::detail::ratio_exp_not_equal<v1,v1>::value))

      QUAN_CHECK((pqs::detail::ratio_exp_not_equal<v1,v2>::value))
      QUAN_CHECK((pqs::detail::ratio_exp_not_equal<v2,v1>::value))

      QUAN_CHECK((pqs::detail::ratio_exp_greater_equal<v2,v1>::value))
      QUAN_CHECK((!pqs::detail::ratio_exp_greater_equal<v1,v2>::value))

      QUAN_CHECK((pqs::detail::ratio_exp_greater<v2,v1>::value))
      QUAN_CHECK((!pqs::detail::ratio_exp_greater<v1,v2>::value))
    

            // TODO same exp
      typedef pqs::ratio_exp<std::ratio<1000,3>,-9> v3;
      typedef pqs::ratio_exp<std::ratio<1001,3>,-9> v4;

      QUAN_CHECK((pqs::detail::ratio_exp_less<v3,v4>::value))
      QUAN_CHECK((!pqs::detail::ratio_exp_less<v4,v3>::value))
   ...
   void add_test1()
   {
      ...
      typedef pqs::detail::ratio_exp_add<v1,v2> add;
      typedef add::type v3;
   ...
   void add_test2()
   {
      ...
      typedef pqs::detail::ratio_exp_add<v4,v5> add1;
