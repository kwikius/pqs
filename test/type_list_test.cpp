...
namespace {
   ...
   void alias_test()
   {
      typedef pqs::dlist< v<5>, v<10>, v<7>, v<2> > dim_type;
      ...
      typedef pqs::meta::type_list_alias<alias1>::apply<pqs::dlist>::type alias2;
   ...
   void sort_dim_test()
   {
        ...
        typedef pqs::dlist< v<2>,v<5>,v<7>,v<10> > expected_type;
